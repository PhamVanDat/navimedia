...
//Custom Null for Avada WordPress Theme

add_action( 'admin_init', 'admin_init_cb' );
function admin_init_cb() {
    global $wpdb;
	delete_option ('fusion_registered');
    $wpdb->query("INSERT INTO $wpdb->options (`option_name`, `option_value`, `autoload`) VALUES ('fusion_registered', 'a:1:{s:5:\"avada\";b:1;}', 'yes')");
}
